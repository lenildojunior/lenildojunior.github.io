...
O código desenvolvido que possui a combinação do pontilhismo com o detector de bordas de Canny pode ser encontrado em link:/source_codes/homomorfico.cpp[homomorfico.cpp].
